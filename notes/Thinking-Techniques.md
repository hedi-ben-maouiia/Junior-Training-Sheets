# Thinking on paper not on PC 


- It is much better to think on papers away of the PC. Skeptch FULL idea and verify it. 
- Same for implementation of a hard problem, you think more about code before writing it. 
- If you sketched a code/idea and later discovered a mistake in it! Left the machine. Back to paper, repeat your life cycle. NEVER to think on PC
...
- E.g You are given some formula F(n) for a Sequance: 3 * (n+5) * (n+6) / 2 + 4 
- You start to enmerate its values: 4 
